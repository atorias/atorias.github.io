import{_ as n,c as a,a as e,o as p}from"./app-o9ryrlfX.js";const l={};function i(t,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="openssh" tabindex="-1"><a class="header-anchor" href="#openssh"><span>openssh</span></a></h1><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token assign-left variable">openssh_version</span><span class="token operator">=</span>openssh-9.6p1</span>
